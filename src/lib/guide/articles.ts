...
export const GUIDE_ARTICLES: GuideArticle[] = [
  {
    ...
    title: {
      ...
      it: "Cos'è la nLPD? Guida completa per le PMI svizzere",
    },
    shortTitle: {
    ...
    description: {
      ...
      it: "La nLPD spiegata in modo semplice: chi è interessato, da quando, e cosa cambia concretamente per una PMI svizzera.",
    },
  ...
  },
  {
    ...
    title: {
      ...
      it: "Registro dei trattamenti di dati: modello e obblighi (nLPD)",
    },
    shortTitle: {
      fr: "Le registre des traitements",
      de: "Das Verarbeitungsverzeichnis",
      en: "Records of processing",
      it: "Il registro dei trattamenti",
    },
    description: {
      ...
      it: "Cosa deve contenere un registro dei trattamenti conforme, chi deve tenerlo, e come implementarlo in una PMI.",
    },
    updatedAt: "2026-09-25",
  },
  {
    ...
    title: {
      ...
      it: "Informativa sulla privacy conforme nLPD: cosa deve contenere",
    },
    shortTitle: {
    ...
    description: {
      ...
      it: "Le indicazioni obbligatorie di un'informativa sulla privacy nLPD, per un sito web come per la gestione HR.",
    },
    updatedAt: "2026-09-25",
  },
  {
    ...
    title: {
      ...
      it: "Sanzioni nLPD: multe e rischi per le PMI e i loro dirigenti",
    },
    shortTitle: {
    ...
    description: {
      ...
      it: "Chi può essere sanzionato, in quali casi, e fino a che importo: cosa prevede realmente la legge revisionata.",
    },
    updatedAt: "2026-09-25",
  },
  {
    ...
    description: {
      ...
      it: "Hosting, CRM, contabilità online: perché questi fornitori devono essere coperti da un contratto di sub-trattamento.",
    },
    updatedAt: "2026-09-25",
  },
];
